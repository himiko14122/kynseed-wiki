...
import { absoluteUrl, HERO_IMAGE, SITE_URL, SITE_NAME, GA_TRACKING_ID } from '@/config/site';
// JSON-LD structured data: Organization + WebSite schemas
import { getAlternates, organizationJsonLd, websiteJsonLd } from '@/lib/seo';
  ...
  return (
    <html lang={validLocale} suppressHydrationWarning>
      <head>
        ...
        <link rel="dns-prefetch" href="https://pl30846357.effectivecpmnetwork.com" />
        {GA_TRACKING_ID && (
          <>
